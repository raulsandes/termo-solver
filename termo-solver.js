...
function pegarPalavra() {
    var letras = document.getElementById("text").value
    console.log(letras)
    for (var i = 0; i < letras.length; i = i + 1) {
        letra = letras[i];
...
function excluirPalavra() {
    var letras = document.getElementById("text-1").value
    console.log(letras)
    for (var i = 0; i < letras.length; i = i + 1) {
        letra = letras[i];
